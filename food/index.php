...
.bg-video {
    ...
    #pauseMuteButton {
        ...
        /* Optional: Add some styling to active link */
...
<body class="home">
                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-toggleable-md  float-lg-right" id="mainNavbarCollapse">
                        <ul class="nav navbar-nav">
                            ...
                            <li class="nav-item"> <a class="nav-link active" href="restaurants.php">Our Restaurants <span class="sr-only"></span></a> </li>
                            <li class="nav-item"> <a class="nav-link active" href="#bottom">About Us <span class="sr-only"></span></a> </li>
    ...
    <video id="bg-video" autoplay muted loop playsinline class="bg-video">
        <source src="images/img/vid1.mp4" type="video/mp4">
        Your browser does not support the video tag.
    </video>
    <script src="script.js"></script>
            <div class="hero-inner">
                <div class="container text-center hero-text font-white">
                    <h1>You Order, We Deliver to you</h1>
                ...
                <button id="pauseMuteButton">Pause & Mute</button>
            </div>
                ...
                <div class="bottom-footer">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-4 address color-gray">
                                    <h5>Address</h5>
                                    <p>30 Lorong Bahagia, Mersing Kecil</p>
                                    <h5><a href="https://wa.me/0108051072" target="_blank">Phone: 0108051072</a></h5>
                                    <h5><a href="https://mail.google.com/mail/?view=cm&fs=1&to=youngbroke0@gmail.com" target="_blank">Email: youngbroke0@gmail.com</a></h5>
                                    </div></h5>
                                <div class="col-xs-12 col-sm-5 additional-info color-gray">
                                    <h5>About Us</h5>
                                   <p>Welcome to OFOS! We specialize in bringing you the finest dishes from top-rated 5-star restaurants, ensuring every meal is a delightful experience. Discover quality food and convenience at your fingertips with OFOS.<br></p>
                                   <h5>Mission</h5>
                                   <p>Our mission at OFOS is to redefine convenience by offering a seamless online food ordering experience that connects food lovers with top-rated restaurants, ensuring every meal is a memorable one.</p>
                                </div>
                    </div>
                </div>
    ...
    document.addEventListener('DOMContentLoaded', (event) => {
        ...
        pauseMuteButton.addEventListener('click', () => {
            if (video.paused) {
                video.play();
                video.muted = false;
                pauseMuteButton.textContent = 'Pause & Mute';
            } else {
                video.pause();
                video.muted = true;
                pauseMuteButton.textContent = 'Play & Unmute';
            }
        });
    });
</script>
